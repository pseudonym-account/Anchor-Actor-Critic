...
class Logger:
    ...
    def _pytorch_simple_save(self, itr=None):
        ...
        if proc_id()==0:
            ...
            # if len(self.pytorch_saver_elements) == 2:

            #     fname_ref = 'ref_model' + ('%d'%itr if itr is not None else '') + '.pt'
                # fname_ref = osp.join(fpath, fname_ref)
            ...
            with warnings.catch_warnings():
                ...
                torch.save(self.pytorch_saver_elements[0], fname)
                
                # if len(self.pytorch_saver_elements) == 2: 
                #     torch.save(self.pytorch_saver_elements[1], fname_ref)
